...
* Update these field values manually if needed. Although the results of the risk analysis are normally stored in the above fields as JSON, you can manually populate them for demo readiness. Feel free to change the JSON values as needed, but DO NOT change the JSON keys.
